module.exports = {
    run: async (hodnoty) => {
        let createCanvas = hodnoty.createCanvas
        let loadImage = hodnoty.loadImage
        ...
        const background = await loadImage(hodnoty.join(__dirname, "../..", "pictures", "xp_background.jpg"));
        ctx.globalAlpha = 0;
        ...
        const attachment = new hodnoty.MessageAttachment(canvas.toBuffer(), `${obraz_jmeno[stav_barva]}.png`);
