...
module.exports = {
    async run(top10, message, response, botconfig) {
        ...
        require("@handlers/find_channel_by_name").run({ zprava: attachment, roomname: botconfig.find(config => config.name == response).value, message: message });
    }
}