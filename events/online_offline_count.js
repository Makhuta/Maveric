...
const updateMembers = guild => {
    ...
    const onlinecount = (guild.members.cache.filter(m => m.presence.status === 'online' || "idle" || "dnd").size.toLocaleString()) - numofallbots
    const offlinecount = numofallmembnobots - onlinecount
